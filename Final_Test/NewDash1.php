            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <hr class="sidebar-divider my-0">
                 <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="addCourse.php"><i class="fas fa-user"></i><span>Add Courses</span>
...
//print  " haha [$test]";
$html = '
<ul class= "popupnav scrollmenu" id = "mcList">
		<p class = "text-center">My Courses</p>
		<hr>
  <li class= "popupnav"><a href="#home" class= "popupnav">Home</a></li>
  <li class= "popupnav"><a href="#news" class= "popupnav">News</a></li>
  <li class= "popupnav"><a href="#contact" class= "popupnav">Contact</a></li>
  <li class= "popupnav"><a href="#about" class= "popupnav">About</a></li>
...
$node = $ul->childNodes->item(3);

// Create the li
$li = $dom->createElement('li');

// Create the link (products for the example)
$a = $dom->createElement('a', 'Products');
