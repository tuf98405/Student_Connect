    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="addCourseP.php"><i class="fas fa-user"></i><span>Add Courses</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="askQuestion.php"><i class="fas fa-table"></i><span>Add Question</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="login.html"><i class="far fa-user-circle"></i><span>CIS 3296</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="register.html"><i class="fas fa-user-circle"></i><span>MAT 2048</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <div style = "">
     <form action="NewDash1.php" style=" height: 100vh; width:100vw;"  method="get">
        <div>
